        ...
        <div class="row">
            ...
            <div class="col-5-xxxl col-12">
                <div class="card dashboard-card-twelve">
                    <div class="card-body">
                        <div class="heading-layout1 mt-4">
                            <h3>My Kids</h3>
                            <div class="item-title">
                        ...
                        <div class="kids-details-wrap">
                            <div class="row">
                                ...
                                <div class="col-12-xxxl col-xl-6 col-12" >
                                    ...
                                    <div class="kids-details-box mb-5" style="background-color: {{ $kid->hex }}">
                                            ...
                                            <table class="table text-nowrap">
                                                ...
                                                <div class="m-2">
                                                    ...
                                                    <div class="mt-5">
                                                        ...
                                                        <a href="{{ route('parent.viewPoints', $kid->id) }}" class="btn btn-success p-2 m-1">View Points</a>
                                                        <a href="{{ route('parent.assignPoints', $kid->id) }}" class="btn btn-success p-2 m-1">Assign Points</a>
                                                        <a href="{{ route('parent.teacher.feedback', $kid->id) }}" class="btn btn-outline-dark p-2 m-1"><i class="bi bi-clock-history"> History</i></a>
                                                        <a href="{{ route('edit.kid', $kid->userId) }}" class="btn btn-outline-success p-2 m-1"><i class="bi bi-pencil"></i></a>
                                                        <a href="{{ route('parent.remove.kid', $kid->id) }}" class="btn btn-del-kid btn-outline-danger p-2 m-1"><i class="bi bi-trash"></i></a>
                                ...
                                <div class="col-12-xxxl col-sm-12 col-12">
                                    ...
                                    <div class="kids-details-box mb-5 hover" id="{{ $kid->id }}"
                                        ...
                                        <div class="item-content table-responsive"> --}}
                                            ...
                                            {{-- <a href="{{route('parent.teacher.feedback', $kid->id)}}" role="button" class="btn btn-outline-primary">
                                                <i class="fa-solid fa-message"></i>&nbsp;History
                                            </a>
                                            <a href="{{route('parent.remove.kid', $kid->id)}}" role="button" class="btn btn-outline-danger btn-del-kid">
                                                <i class="fa-solid fa-trash"></i>
                                            </a>
                                            <a href="{{route('edit.kid', $kid->userId)}}" role="button" class="btn btn-outline-success">
